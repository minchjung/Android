...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean isTestAsync=false;
    float scale;
    ProgressBar prog1;
    ProgressBar prog2;
    ProgressBar prog3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gaugeData = new GaugeData(findViewById(R.id.textView));
        gaugeData.execute();
...
//    }
    ...
    private void setGauge() {
        float gap = scale/2;
        prog1.setProgress((Integer.parseInt(""+data[100])));
        prog2.setProgress((Integer.parseInt(""+data[101])));
        prog3.setProgress((Integer.parseInt(""+data[102])));
